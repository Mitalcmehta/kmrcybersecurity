...
header="""
    ...
    Hi this is Mital Parekh
    Here going to show how we can bypass the firewall by applying payload"
    Sqli.py --help help command
    sqli.py --url "Enter url to bypass the firewall"
"""
print header
